    ...
    <main class="mdl-layout__content">
        ...
        <div class="mdl-grid mdl-grid--no-spacing dashboard">
            ...
            <tr>
                ...
                <td class="mdl-data-table__cell--non-numeric">{{$value->syllabus}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->status}}</td>
                <td class="mdl-data-table__cell--non-numeric"><a href="/saprove/{{$value->id}}">aprove</a></td>
                <td class="mdl-data-table__cell--non-numeric"><a href="/sdecline/{{$value->id}}">decline</a></td>
            </tr>
    </tbody>
            @endforeach
              </table>
