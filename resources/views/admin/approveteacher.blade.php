        ...
        <div class="mdl-grid mdl-grid--no-spacing dashboard">
            ...
            <div class="mdl-card__supporting-text no-padding">
                        <table class="mdl-data-table mdl-js-data-table">
                            <thead>
                                <tr>
                  <td class="mdl-data-table__cell--non-numeric">Teacherid</td>
                    <td class="mdl-data-table__cell--non-numeric">Name</td>
                    <td class="mdl-data-table__cell--non-numeric">Email</td>
                    <td class="mdl-data-table__cell--non-numeric">Qualification</td>
                    <td class="mdl-data-table__cell--non-numeric">Dob</td>
                    <td class="mdl-data-table__cell--non-numeric">Pincode</td>
                    ...
                    <td class="mdl-data-table__cell--non-numeric">Phone no:</td>
                    <td class="mdl-data-table__cell--non-numeric">Language</td>
            ...
            <tr>
                ...
                <td class="mdl-data-table__cell--non-numeric">{{$value->qualification}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->dob}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->pin}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->gender}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->dis}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->dept}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->phno}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->lan}}</td>
                <td class="mdl-data-table__cell--non-numeric">{{$value->status}}</td>
                <td class="mdl-data-table__cell--non-numeric"><a href="/aprove/{{$value->id}}">aprove</a></td>
                <td class="mdl-data-table__cell--non-numeric"><a href="/decline/{{$value->id}}">decline</a></td>
            </tr>
    </tbody>
            @endforeach
              </table>
