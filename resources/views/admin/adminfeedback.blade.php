                ...
                <table class="mdl-data-table mdl-js-data-table stripped-table">
                    <thead>
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">tname</td>
                            <td class="mdl-data-table__cell--non-numeric">feedback</td>
                        </tr>
                    </thead>
                    <tbody>            
                        ...
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">{{$value->tname}}</td>
                            <td class="mdl-data-table__cell--non-numeric">{{$value->feedback}}</td>
                        </tr>
                    </tbody>
                            @endforeach
                    </table>
