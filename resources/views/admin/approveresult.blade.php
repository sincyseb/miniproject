                ...
                <table class="mdl-data-table mdl-js-data-table stripped-table">
                    ...
                    <tbody>            
                        ...
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">{{$value->result}}</td>
                            <td class="mdl-data-table__cell--non-numeric">{{$value->status}}</td>
                            <td class="mdl-data-table__cell--non-numeric"><a href="/raprove/{{$value->id}}">aprove</a></td>
                            <td class="mdl-data-table__cell--non-numeric"><a href="/rdecline/{{$value->id}}">decline</a></td>
                        </tr>
                    </tbody>
                            @endforeach
                    </table>
