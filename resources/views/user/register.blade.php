          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="/register">Student Register
                <span class="sr-only">(current)</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/tregister">Teacher Register</a>
              </li>
              <li class="nav-item">
    ...
    <div class="col-md-12">
      <div class="container"> 
            <div class="contact-form">
              <form id="sreg" action="sreg" method="post">
                @csrf
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      E-mail:
                      <input name="email" type="text" class="form-control" id="email" placeholder="E-Mail Address" required=""><br>
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Father's name:
                      <input name="fname" type="text" class="form-control" id="fname" placeholder="Father's Name" required=""><br>
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Mother's name:
                      <input name="mname" type="text" class="form-control" id="mname" placeholder="Mother's Name" required=""><br>
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Semester:
                      <input name="sem" type="text" class="form-control" id="sem" placeholder="Your semester" required=""><br>
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
