        ...
        <div class="container">
          ...
          <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu active">
                    <a class="dropdown-item" href="/uploadsyllabus">Upload syllabus
                    
                    </a>
                    <a class="dropdown-item" href="/uploadnotes" >Upload Notes
                   
                    </a>
                    <a class="dropdown-item" href="/uploadtimetable">Upload TimeTables
              ...
              <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu ">
                    <a class="dropdown-item" href="/tviewsyllabus">view syllabus
    ...
    <div class="col-md-12">
      <div class="container"> 
            <div class="contact-form">
              <form id="" action="/timetables" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Course:
                      <input name="course" type="text" class="form-control" id="course" placeholder="enter your course" required=""><br>
                    </fieldset>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Subject:
                      <input name="sub" type="text" class="form-control" id="sub"  required=""><br>
                    </fieldset>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Date:
                      <input name="date" type="date" class="form-control" id="date"  required=""><br>
                    </fieldset>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      Time:
                      <input name="time" type="time" class="form-control" id="time"  required=""><br>
                    </fieldset>
                  </div>
                </div>
