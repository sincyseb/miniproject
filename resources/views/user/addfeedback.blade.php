        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item ">
              <li class="nav-item ">
                <a class="nav-link" href="/studenthome">Home
                  
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/sviewsyllabus">Syllabus</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/sviewnotes">Notes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/sviewtimetable">TimeTables</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/sviewresult">Results</a>
              </li>
              <li class="nav-item">
            ...
            <div class="contact-form">
              <form id="feedback" action="feedback" method="post">
                ...
                <div>
                    <fieldset>
                      Teacher Name:
                      <input name="tname" type="text" class="form-control" id="feedbacks"  placeholder="teacher name" required=""><br>
                    </fieldset>
                  </div>
                  <div>
                    <fieldset>
                      Feedback:
                      <input name="feedback" type="text" class="form-control" id="feedbacks"  placeholder="Give feedback to teachers" required=""><br>
                    </fieldset>
                  </div>
                  </div>
                  <div >
